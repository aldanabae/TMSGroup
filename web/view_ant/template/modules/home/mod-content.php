...
$links = $posts['links'];
?>
<form id="paginator1" method="post">
  <input type="hidden" id="page1" name="page" value="1" />
  <div class="col-md-8">
    <div class="row container-post">
      <?php
      if (isset($posts['posts_home']) && count($posts['posts_home']) > 0) :
        foreach ($posts['posts_home'] as $item) :
          ...
          $class = ($item['CategoriaID'] == 10) ? 'post-dark' : '';
          ?>
          <article class="<?php echo $class; ?> post format-standard hentry entry-list">
            <div class="row">
