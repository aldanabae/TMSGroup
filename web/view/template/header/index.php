...
<!--            <a href="index-2.html">
              ...
              <span class="ms-logo animated zoomInDown animation-delay-5">TMS Group</span>
              <h1 class="animated fadeInRight animation-delay-6">Material
                <span>Style</span>
              </h1>
            </a>-->
            <a href="http://localhost/TMSGroup/" title="TMS Group" rel="home">
							<img class="img-responsive" src="<?php echo URL_IMG; ?>logo.png" style="height:100px; width:300px;">
						</a>
          </div>
