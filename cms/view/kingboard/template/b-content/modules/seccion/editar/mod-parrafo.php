  ...
  <div class="widget">
    ...
    <div class="widget-content">
      ...
      <div id="boxlink_<?php echo $data['cur']; ?>" class="form-group" style="<?php echo $displayLink; ?>">
        ...
        <div class="controls">
          <input type="text" class="form-control" id="enlace_<?php echo $data['cur']; ?>" name="paragraph[<?php echo $data['cur'] - 1; ?>][Link]" value="<?php if (isset($data['parrafo'][$data['cur'] - 1]['Link'])) echo $data['parrafo'][$data['cur'] - 1]['Link']; ?>" />
          <p class="help-block"></p>
        </div>
      </div>
      <div class="cont-hint">
