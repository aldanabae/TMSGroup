  ...
  <div class="widget">
    ...
    <div class="widget-content">
      <div class="form-group">
        ...
        <div class="controls">
          <input type="text" class="form-control" id="asunto" name="<?php echo $tabla; ?>[Asunto]" value="RE: <?php if (isset($data[$tabla]['Asunto'])) echo $data[$tabla]['Asunto']; ?>" />
  ...
  <div class="widget">
    ...
    <div class="widget-content">
      <div class="form-group">
        ...
        <div class="controls">
          <input type="hidden" id="remitente" name="<?php echo $tabla; ?>[Remitente]" value="<?php if (isset($data[$tabla]['Destinatario'])) echo $data[$tabla]['Destinatario']; ?>" />
          <div class="tag-email">
            <input id="tag-input" type="text" name="tags" placeholder="Ej. correo@empresa.com" class="tm-input" />
            <input type="hidden" id="destinatario" name="<?php echo $tabla; ?>[Destinatario]" value="<?php if (isset($data[$tabla]['Remitente'])) echo $data[$tabla]['Remitente']; ?>" />
          </div>
          <p class="help-block"></p>
        </div>
      </div>
