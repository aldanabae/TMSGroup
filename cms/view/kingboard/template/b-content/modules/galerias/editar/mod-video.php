<div id="galeria_<?php echo $data['num']; ?>" class="gal-item">
  <div class="gal-image">
    <a id="gale_<?php echo $data['num']; ?>" href="<?php echo $data['image']; ?>" data-fancybox-group="gallery" class="fancybox">
      <img class="list-group-image" id="img-galeria_<?php echo $data['num']; ?>" src="<?php echo $data['thumb']; ?>" width="260" />
  ...
  <div class="gal-caption">
    <h3 class="inner list-group-item-heading">C&oacute;digo: <?php echo $data['name']; ?></h3>
