...
<input type="hidden" name="<?php echo $tabla; ?>[Tipo]" id="publico" value="<?php if (isset($data['type'])) echo $data['type']; ?>">
<div class="col-md-8">
  <div class="widget">
    ...
    <div class="widget-content">
      ...
      <div class="form-group">
        ...
        <div class="controls">
          ...
          <p class="help-block">Su enlace se vera en: <?php echo URL_WEB . 'galerias/'; ?><strong id="friendly-url"><?php if (isset($data[$tabla]['URL'])) echo $data[$tabla]['URL']; ?></strong></p>
        </div>
      </div>
      <div class="form-group">
        <label class="control-label" for="detalle">Descripci&oacute;n:</label>
        <div class="controls">
          <textarea id="sumario" maxlength="250" name="<?php echo $tabla; ?>[Descripcion]" class="form-control" rows="3"><?php if (isset($data[$tabla]['Descripcion'])) echo $data[$tabla]['Descripcion']; ?></textarea>
          <p class="help-block"></p>
        </div>
      </div>
      <div class="cont-hint">
...
<div class="col-md-4">
  <div class="widget">
    ...
    <div class="widget-content">
      <div class="form-group">
        <label class="control-label" for="fecha"><span class="obligatory">*</span> Fecha:</label>
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
          <input class="form-control datepicker" type="text" id="fecha" name="<?php echo $tabla; ?>[Fecha]" value="<?php if (isset($data[$tabla]['Fecha'])) echo $data[$tabla]['Fecha']; ?>" />
        </div>      
        <p class="help-block"></p>
      </div>
      <div class="form-group">
