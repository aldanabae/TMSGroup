<div class="panel-body table-responsive">
  <?php if (isset($data['heads']) && count($data['heads'])) : ?>
    <table class="table table-condensed message-table" id="list-table">
      <thead>
        <tr class="odd">
        ...
        <tr>
          ...
          foreach ($data['heads'] as $head) :
            ?>
            <th class="<?php echo $head['sort']; ?>" data-align="<?php echo $head['align']; ?>">
              <?php echo $head['title']; ?>
            </th>
            <?php
          endforeach;
          ?>
          <th class="nosort center" data-align="center">Acci&oacute;n</th>
        </tr>
      </thead>
      <tbody>
        <tr>
